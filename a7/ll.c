...
int InsertLinkedList(LinkedListPtr list, char* newData)
{
...
LinkedListPtr AppendLinkedList(LinkedListPtr list, char* newData)
{
    LinkedListNodePtr newNode;
    newNode = CreateLinkedListNode(newData);
    if (newNode == NULL)
...
LinkedListNode* CreateLinkedListNode(char* cdata)
{
    LinkedListNode* newNode = (LinkedListNode*)malloc(sizeof(LinkedListNode));

    if (newNode == NULL)
        return NULL;
    // printf("create linkedlist node is %s", cdata);
    newNode->data = cdata;
    newNode->prev = NULL;
    newNode->next = NULL;
